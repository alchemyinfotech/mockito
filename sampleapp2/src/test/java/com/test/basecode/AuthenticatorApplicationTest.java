...
import basecode.AuthenticatorApplication;
import basecode.AuthenticatorInterface;
import basecode.EmptyCredentialsException;
...
public class AuthenticatorApplicationTest {
    ...
    public void testAuthenticateMockInjection() throws EmptyCredentialsException {
        ...
        boolean actual = this.authenticator.authenticate("javacodetests", "s4f3 p4ssw0rd");
